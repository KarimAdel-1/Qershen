...
const Test = () => {
  ...
  return (
    <section className="flex h-screen w-full overflow-hidden border py-[72px]">
        ...
        >
          ...
          <div className="flex w-full items-center justify-between">
            ...
            <button
              id="prev"
              onClick={prevSlide}
              className="border-none bg-transparent font-mono text-6xl font-bold text-green-500 opacity-50 transition-opacity duration-500 hover:opacity-100"
            >
              {'<'}
            </button>
            <button
